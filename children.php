    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="image/ch-cas.jpg" width="800" height="600" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h5>Kid's Collection</h5>
                </div>
            </div>
            <div class="carousel-item">
                <img src="image/ch-sp.jpg" width="800" height="600" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h5>Sport</h5>
                </div>
            </div>
            <div class="carousel-item">
                <img src="image/ch-st.jpg" width="800" height="600" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h5>Casual</h5>
                </div>
            </div>
        ...
        <div  style="padding: 10px" class="col">
            ...
            <div style="padding: 10px ;" class="col ad">
                ...
                if ($db->connect_error) {
                    ...
                    $sql = "SELECT * FROM products WHERE `department`='Children' and `type`='Pants' ORDER by `idproducts` DESC";
            ...
            <div style="padding: 10px ;" class="col ad">
                ...
                if ($db->connect_error) {
                    ...
                    $sql = "SELECT * FROM products WHERE `department`='Children' and `type`='Shirts' ORDER by `idproducts` DESC";
            ...
            <div style="padding: 10px ;" class="col ad">
                ...
                if ($db->connect_error) {
                    ...
                    $sql = "SELECT * FROM products WHERE `department`='Children' and `type`='Shorts' ORDER by `idproducts` DESC";
