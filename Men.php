    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="image/men-col.jpg" width="800" height="600" class="d-block w-100" alt="...">
            ...
            <div class="carousel-item">
                <img src="image/men_sp.jpg" width="800" height="600" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h5>Sport</h5>
                </div>
            </div>
            <div class="carousel-item">
                <img src="image/men-cas.jpg" width="800" height="600" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h5>Casual</h5>
                </div>
            </div>
            <div class="carousel-item">
                <img src="image/men-sut.jpg" width="800" height="600" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h5>Suites</h5>
                </div>
            </div>
        ...
        <div style="padding: 10px" class="row">
            ...
            <div style="padding: 10px ;" class="col ad">
                ...
                if ($db->connect_error) {
                    ...
                    $sql = "SELECT * FROM products WHERE `department`='Men' and `type`='Pants' ORDER by `idproducts` DESC";
            ...
            <div style="padding: 10px ;" class="col ad">
                ...
                if ($db->connect_error) {
                    ...
                    $sql = "SELECT * FROM products WHERE `department`='Men' and `type`='Shirts' ORDER by `idproducts` DESC";
            ...
            <div style="padding: 10px ;" class="col ad">
                ...
                if ($db->connect_error) {
                    ...
                    $sql = "SELECT * FROM products WHERE `department`='Men' and `type`='Shorts' ORDER by `idproducts` DESC";
